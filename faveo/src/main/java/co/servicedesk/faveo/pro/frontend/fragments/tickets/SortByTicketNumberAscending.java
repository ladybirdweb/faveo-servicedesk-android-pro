 ...
 */
public class SortByTicketNumberAscending extends Fragment {
    ...
    int assigned=1;
    String url;
    private SortByTicketNumberAscending.OnFragmentInteractionListener mListener;
    ...
    public SortByTicketNumberAscending(){
...
//        TextView mTitle = (TextView) toolbar.findViewById(R.id.toolbar_title);
            ...
            //toolbar.setTitle(getString(R.string.sortbyticketnumber));
...
//            });
            try {
                filterwithsorting = Prefs.getString("filterwitjsorting", null);
            }
...
//        mTitle.setText("Sort By");
            ...
            if (InternetReceiver.isConnected()) {
                ...
                if (show.equals("1")){
                    dept="mytickets";
                    dialog1.show();
                    new FetchFirstAscending(getActivity(),dept+"&assigned=0","ticket_number","ASC",1).execute();
                    ...
                    new FetchFirstFilter(getActivity(),url+"&sort-by=ticket_number&order=ASC",pageNo).execute();
                    //Toast.makeText(getActivity(), "came here", Toast.LENGTH_SHORT).show();
                }


//                progressDialog.show();
//                new FetchFirstAscending(getActivity(),"inbox","updated_at","ASC",1).execute();
            } else {
...
//                }
    ...
    private class FetchNextPage extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... urls) {
            ...
            String result = new Helpdesk().nextPageSorting(dept,"ticket_number","ASC",page);
            if (result == null)
                return null;
...
//                    }
        ...
        public void onDestroyActionMode(android.support.v7.view.ActionMode mode) {
            ...
            SortByTicketNumberAscending sortByTicketNumberAscending=new SortByTicketNumberAscending();
            //recyclerView_adapter.removeSelection();
            sortByTicketNumberAscending.setNullToActionMode();
