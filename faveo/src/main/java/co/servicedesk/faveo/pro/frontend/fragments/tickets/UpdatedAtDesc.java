 ...
 */
public class UpdatedAtDesc extends Fragment {
    ...
    private UpdatedAtDesc.OnFragmentInteractionListener mListener;
    String status;
    int id=0;
    public static UpdatedAtDesc newInstance(String param1, String param2) {
        UpdatedAtDesc fragment = new UpdatedAtDesc();
...
//        mTitle.setText("Sort By");
            ...
            if (InternetReceiver.isConnected()) {
                ...
                if (show.equals("1")){
                    ...
                    assigned=0;
                   dialog1.show();
                    new FetchFirstAscending(getActivity(),dept+"&assigned=0","updated_at","DESC",1).execute();
                   ...
                   dialog1.show();
                    ...
                    dialog1.show();
                    new FetchFirstFilter(getActivity(),url+"&sort-by=updated_at&order=DESC",1).execute();
                    //Toast.makeText(getActivity(), "came here", Toast.LENGTH_SHORT).show();
                }
//                progressDialog.show();
//                new FetchFirstAscending(getActivity(),"inbox","updated_at","DESC",1).execute();
            } else {
...
//                }
    ...
    private class FetchNextPage extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... urls) {
            ...
            String result = new Helpdesk().nextPageSorting(dept,"updated_at","DESC",page);
            if (result == null)
                return null;
...
//        }
    ...
    public class Toolbar_ActionMode_Callback implements android.support.v7.view.ActionMode.Callback {
        ...
        public boolean onCreateActionMode(android.support.v7.view.ActionMode mode, Menu menu) {
            ...
            getActivity().getActionBar().setHomeAsUpIndicator(R.drawable.ic_close_24dp);
...
//
        ...
        public void onDestroyActionMode(android.support.v7.view.ActionMode mode) {
            ...
            UpdatedAtDesc updatedAtDesc=new UpdatedAtDesc();
            //recyclerView_adapter.removeSelection();
            updatedAtDesc.setNullToActionMode();
