 ...
 */
public class  CreatedAtDesc extends Fragment {
    ...
    int id=0;
    SpotsDialog dialog1;
    public static CreatedAtDesc newInstance(String param1, String param2) {
        CreatedAtDesc fragment = new CreatedAtDesc();
...
//                progressDialog.show();
//                new FetchFirstAscending(getActivity(),"inbox","created_at","DESC",1).execute();
            } else {
...
//                }
    ...
    private class FetchNextPage extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... urls) {
            ...
            String result = new Helpdesk().nextPageSorting(dept,"created_at","DESC",page);
            if (result == null)
                return null;
            // DatabaseHandler databaseHandler = new DatabaseHandler(context);
...
//                    }
        ...
        public void onDestroyActionMode(android.support.v7.view.ActionMode mode) {
            ...
            CreatedAtDesc createdAtDesc=new CreatedAtDesc();
            //recyclerView_adapter.removeSelection();
            createdAtDesc.setNullToActionMode();
