...
//                WindowManager.LayoutParams.FLAG_FULLSCREEN);
        ...
        try {
            newurl = Prefs.getString("companyUrl", null);
...
//                Toast.makeText(TicketMergeActtivity.this, "id :"+ids, Toast.LENGTH_SHORT).show();
                ...
                new MultipartUploadRequest(TicketMergeActtivity.this,  newurl + "api/v2/helpdesk/merge/?token="+token)
                        .addParameter("p_id", String.valueOf(id))
                        .addParameter("title",title)
                        .addParameter("reason",reason)
                        .addParameter("t_id[]","51,53")
