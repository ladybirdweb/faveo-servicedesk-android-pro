package co.servicedesk.faveo.pro.frontend.fragments.ticketDetail;
...
import co.servicedesk.faveo.pro.frontend.activities.ShowingAttachment;
...
//        }
            ...
            ticketViewHolder.replyIcon.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    intent.putExtra("ticket_id", ticketThread.getTicketId());
                    view.getContext().startActivity(intent);
                }
            });
