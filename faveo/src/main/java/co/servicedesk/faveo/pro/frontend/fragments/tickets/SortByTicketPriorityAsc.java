 ...
 */
public class SortByTicketPriorityAsc extends Fragment {
    ...
    private SortByTicketPriorityAsc.OnFragmentInteractionListener mListener;

    public static SortByTicketPriorityAsc newInstance(String param1, String param2) {
        SortByTicketPriorityAsc fragment = new SortByTicketPriorityAsc();
    ...
    public SortByTicketPriorityAsc() {
...
//                    if (item.getItemId()==R.id.ticketidasc){
//                        title = getString(R.string.sortbyticketidasc);
//                        fragment = getActivity().getSupportFragmentManager().findFragmentByTag(title);
//                        if (fragment == null)
...
//                        }
//                    }
//                    if (item.getItemId()==R.id.ticketiddesc){
//                        title = getString(R.string.sortbyticketiddesc);
//                        fragment = getActivity().getSupportFragmentManager().findFragmentByTag(title);
//                        if (fragment == null)
//                            fragment = new SortByTicketIdDesc();
//                        if (fragment != null) {
//                            FragmentManager fragmentManager = getActivity().getSupportFragmentManager();
//                            FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
//                            fragmentTransaction.replace(R.id.container_body, fragment);
...
//                    }
            ...
            if (InternetReceiver.isConnected()) {
                ...
                if (show.equals("1")){
                    ...
                    assigned=0;
                    dialog1.show();
                    new FetchFirstAscending(getActivity(),dept+"&assigned=0","priority","ASC",1).execute();
                    ...
                    new FetchFirstFilter(getActivity(),url+"&sort-by=priority&order=ASC",1).execute();
            ...
            swipeRefresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
                ...
                public void onRefresh() {
                    if (InternetReceiver.isConnected()) {
                        ...
                        //new FetchFirstAscending(getActivity(),"inbox","priority","ASC",1).execute();
                    } else {
                        recyclerView.setVisibility(View.INVISIBLE);
                    ...
                    if (dy > 0) {
                        ...
                        if (loading) {
                            if ((visibleItemCount + pastVisibleItems) >= totalItemCount) {
                                loading = false;
                                pageno++;
                                new FetchNextPage(getActivity(),pageno,"ASC").execute();
...
//    private class FetchFirstDescending extends AsyncTask<String, Void, String> {
//        Context context;
//
//        FetchFirstDescending(Context context) {
//            this.context = context;
//        }
//
//        protected String doInBackground(String... urls) {
...
////                return "all done";
////            }
//            String result = new Helpdesk().getSortByTicketWithTitle(dept,"ticket_title","DESC");
//            if (result == null)
//                return null;
//            String data;
//            ticketOverviewList.clear();
...
//                            if ((visibleItemCount + pastVisibleItems) >= totalItemCount) {
//                                loading = false;
//                                //new FetchNextPage(getContext(),pageno).execute();
//                                pageno++;
//                                new FetchFirstAscending(getActivity(),"inbox","priority","ASC",1).execute();
//                                StyleableToast st = new StyleableToast(getContext(), getString(R.string.loading), Toast.LENGTH_SHORT);
//                                st.setBackgroundColor(Color.parseColor("#3da6d7"));
...
//    }
    ...
    private class FetchNextPage extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... urls) {
            ...
            String result = new Helpdesk().nextPageSorting(dept,"priority","ASC",page);
            if (result == null)
                return null;
            // DatabaseHandler databaseHandler = new DatabaseHandler(context);
...
//            .into(ticketViewHolder.roundedImageViewProfilePic);
                ...
                //ticketViewHolder.roundedImageViewProfilePic.setImageDrawable(drawable);
                ticketViewHolder.roundedImageViewProfilePic.setImageResource(R.drawable.default_pic);
            }
                            ...
                            new BottomDialog.Builder(getActivity())
                                    ...
                                    .onPositive(new BottomDialog.ButtonCallback() {
                                        ...
                                        public void onClick(BottomDialog dialog) {
                                            if (InternetReceiver.isConnected()){
                                                dialog1= new SpotsDialog(getActivity(), getString(R.string.changingStatus));
                                                dialog1.show();
...
//                    }
        ...
        public void onDestroyActionMode(android.support.v7.view.ActionMode mode) {
            ...
            SortByTicketPriorityAsc sortByTicketPriorityAsc=new SortByTicketPriorityAsc();
            //recyclerView_adapter.removeSelection();
            sortByTicketPriorityAsc.setNullToActionMode();
