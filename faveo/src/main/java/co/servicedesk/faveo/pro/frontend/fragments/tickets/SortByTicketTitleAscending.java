...
// */
//public class SortByTicketTitleAscending extends Fragment {
...
//
//    public static SortByTicketTitleAscending newInstance(String param1, String param2) {
//        SortByTicketTitleAscending fragment = new SortByTicketTitleAscending();
...
//
//
//    public SortByTicketTitleAscending() {
...
//                        dept="mytickets";
//                        progressDialog.show();
//                        new FetchFirstAscending(getActivity(),dept,"ticket_titile","ASC",1,assigned).execute();
...
//
//                        progressDialog.show();
//                        new FetchFirstFilter(getActivity(),url+"&sort-by=ticket_titile&order=ASC",pageNo).execute();
//                        //Toast.makeText(getActivity(), "came here", Toast.LENGTH_SHORT).show();
//                    }
////                    progressDialog.show();
////                    new FetchFirstAscending(getActivity(),"inbox","ticket_titile","ASC",1).execute();
//                } else {
...
//                                //Toast.makeText(getActivity(), "came here", Toast.LENGTH_SHORT).show();
//                            }
//                            //new FetchFirstAscending(getActivity(),dept,"ticket_titile","ASC",1).execute();
//                        } else {
//                            recyclerView.setVisibility(View.INVISIBLE);
...
////                return "all done";
////            }
//            String result = new Helpdesk().getSortByTicketWithTitle(dept,title,order,assigned);
//            if (result == null)
//                return null;
//            String data;
