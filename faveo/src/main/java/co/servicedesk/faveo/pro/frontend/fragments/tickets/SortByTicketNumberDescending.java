 ...
 */
public class SortByTicketNumberDescending extends Fragment {
    ...
    private SortByTicketNumberDescending.OnFragmentInteractionListener mListener;
    ArrayList<Data> statusItems;
    String status;
    int id=0;
    public static SortByTicketNumberDescending newInstance(String param1, String param2) {
        // Required empty public constructor
        SortByTicketNumberDescending fragment=new SortByTicketNumberDescending();
    ...
    public SortByTicketNumberDescending(){
...
//                progressDialog.show();
//                new FetchFirstAscending(getActivity(),"inbox","ticket_number","DESC",1).execute();
            } else {
...
//                return "all done";
//            }
            String result = new Helpdesk().getSortByTicketWithTitle(show,title,"DESC");
            if (result == null)
                return null;
            String data;
...
//                }
    ...
    private class FetchNextPage extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... urls) {
            ...
            String result = new Helpdesk().nextPageSorting(dept,"ticket_number",order,page);
            if (result == null)
                return null;
...
//                    }
        ...
        public void onDestroyActionMode(android.support.v7.view.ActionMode mode) {
            ...
            SortByTicketNumberDescending sortByTicketNumberDescending=new SortByTicketNumberDescending();
            //recyclerView_adapter.removeSelection();
            sortByTicketNumberDescending.setNullToActionMode();
