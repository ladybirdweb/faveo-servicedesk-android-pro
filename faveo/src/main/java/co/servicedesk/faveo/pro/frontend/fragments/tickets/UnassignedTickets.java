...
//                return "all done";
//            }
            String result = new Helpdesk().getUnassignedTicket(page);
            if (result == null)
                return null;
            String data;
            ...
            try {
                ...
                try {
                    ...
                    int unasigned = jsonObject1.getInt("total");
                    if (unasigned > 999)
                    ...
                    if (dy > 0) {
                        ...
                        if (loading) {
                            if ((visibleItemCount + pastVisibleItems) >= totalItemCount) {
                                loading = false;
                                pageno++;
                                new FetchNextPage(getActivity(),"inbox"+"&assigned=0",pageno).execute();
    ...
    private class FetchNextPage extends AsyncTask<String, Void, String> {
        ...
        String show;
        int page;
        FetchNextPage(Context context,String show,int page) {
            this.context = context;
            this.show=show;
            this.page=page;
        }
...
//            startActivity(intent);
        ...
        public void onDestroyActionMode(android.support.v7.view.ActionMode mode) {
            ...
            UnassignedTickets unassignedTickets=new UnassignedTickets();
            //recyclerView_adapter.removeSelection();
            unassignedTickets.setNullToActionMode();
