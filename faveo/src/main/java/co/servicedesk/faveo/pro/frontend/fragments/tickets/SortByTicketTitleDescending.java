...
// */
//public class SortByTicketTitleDescending extends Fragment {
...
//    String ticket;
//
//    private MyTickets.OnFragmentInteractionListener mListener;
//
//    public static SortByTicketTitleDescending newInstance(String param1, String param2) {
//        SortByTicketTitleDescending fragment = new SortByTicketTitleDescending();
...
//
//
//    public SortByTicketTitleDescending() {
...
//                        dept="mytickets";
//                        progressDialog.show();
//                        new FetchFirstAscending(getActivity(),dept,"due","ASC",1,assigned).execute();
...
//
//                        progressDialog.show();
//                        new FetchFirstFilter(getActivity(),url+"&sort-by=ticket_titile&order=DESC",pageNo).execute();
//                        //Toast.makeText(getActivity(), "came here", Toast.LENGTH_SHORT).show();
//                    }
////                    progressDialog.show();
////                    new FetchFirstAscending(getActivity()).execute();
//                } else {
...
//                        dept="mytickets";
//                        progressDialog.show();
//                        new FetchFirstAscending(getActivity(),dept,"due","DESC",1,assigned).execute();
//                        ((MainActivity) getActivity()).setActionBarTitle(getString(R.string.my_tickets));
//                    }
//                    else if (show.equals("2")){
//                        dept="inbox";
...
//                                dept="mytickets";
//                                progressDialog.show();
//                                new FetchFirstAscending(getActivity(),dept,"ticket_titile","DESC",1,assigned).execute();
//                                ((MainActivity) getActivity()).setActionBarTitle(getString(R.string.my_tickets));
//                            }
//                            else if (show.equals("2")){
//                                dept="inbox";
...
//                                ((MainActivity) getActivity()).setActionBarTitle(getString(R.string.inbox));
//                            }
//                            //new FetchFirstAscending(getActivity(),dept,"ticket_titile","DESC",1).execute();
//                        } else {
//                            recyclerView.setVisibility(View.INVISIBLE);
//                            swipeRefresh.setRefreshing(false);
//                            empty_view.setVisibility(View.GONE);
...
//        String order;
//        int assigned;
//        FetchFirstAscending(Context context,String show,String title,String order,int page,int assigned) {
//            this.context = context;
//            this.page=page;
//            this.show=show;
//            this.title=title;
...
////                return "all done";
////            }
//            String result = new Helpdesk().getSortByTicketWithTitle(show,title,order,assigned);
//            if (result == null)
//                return null;
//            String data;
...
//                return "all done";
//            }
//            String result = new Helpdesk().nextPageSorting(dept,"ticket_title",order,page);
//            if (result == null)
//                return null;
//            // DatabaseHandler databaseHandler = new DatabaseHandler(context);
...
//        if (context instanceof MyTickets.OnFragmentInteractionListener) {
//            mListener = (MyTickets.OnFragmentInteractionListener) context;
//        } else {
