 ...
 */
public class DueByAsc extends Fragment {
    ...
    int id=0;
    private DueByAsc.OnFragmentInteractionListener mListener;

    public static DueByAsc newInstance(String param1, String param2) {
        DueByAsc fragment = new DueByAsc();
...
//                    }
        ...
        public void onDestroyActionMode(android.support.v7.view.ActionMode mode) {
            ...
            DueByAsc dueByAsc=new DueByAsc();
            //recyclerView_adapter.removeSelection();
            dueByAsc.setNullToActionMode();
