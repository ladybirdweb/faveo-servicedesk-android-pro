 ...
 */
public class UpdatedAtAsc extends Fragment {
    ...
    private UpdatedAtAsc.OnFragmentInteractionListener mListener;
    ArrayList<Data> statusItems;
    String status;
    int id=0;
    public static UpdatedAtAsc newInstance(String param1, String param2) {
        UpdatedAtAsc fragment = new UpdatedAtAsc();
...
//            Toolbar toolbar2= (Toolbar) rootView.findViewById(R.id.toolbar3);
//            toolbar2.setVisibility(View.VISIBLE);
//            toolbar2.setOverflowIcon(getResources().getDrawable(R.drawable.ic_filter_list_black_24dp));
//            toolbar2.setTitle("Filter By :");
//            toolbar2.setTitleTextColor(Color.parseColor("#3da6d7"));
//
//            toolbar2.inflateMenu(R.menu.menu_for_filtering);
...
//                }
    ...
    private class FetchNextPage extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... urls) {
            ...
            String result = new Helpdesk().nextPageSorting(dept,"due","ASC",page);
            if (result == null)
                return null;
            // DatabaseHandler databaseHandler = new DatabaseHandler(context);
...
//                    }
        ...
        public void onDestroyActionMode(android.support.v7.view.ActionMode mode) {
            ...
            UpdatedAtAsc updatedAtAsc=new UpdatedAtAsc();
            //recyclerView_adapter.removeSelection();
            updatedAtAsc.setNullToActionMode();
